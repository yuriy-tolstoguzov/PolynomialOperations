...
- (void)testRationalStringRepresentation0 {
    r_pln_t polinom;
    r_pln_init_set_ui(&polinom, 0b0);
    mp_bitcnt_t stringSize = r_pln_pretty_str_size(polinom);
    char pretty_str[stringSize];
    r_pln_get_pretty_str(pretty_str, polinom);
...
- (void)testRationalStringRepresentation010000 {
    r_pln_t polinom;
    r_pln_init_set_ui(&polinom, 0b1000000000000);
    mp_bitcnt_t stringSize = r_pln_pretty_str_size(polinom);
    char pretty_str[stringSize];
    r_pln_get_pretty_str(pretty_str, polinom);
    NSString *str = [[NSString alloc] initWithUTF8String:pretty_str];
...
- (void)testRationalStringRepresentation01276601_010000 {
    r_pln_t polinom;
    r_pln_init_set_ui(&polinom, 0b1010111110110000001);
    pln_init_set_ui(polinom.denominator, 0b1000000000000);
    mp_bitcnt_t stringSize = r_pln_pretty_str_size(polinom);
    char pretty_str[stringSize];
    r_pln_get_pretty_str(pretty_str, polinom);
    NSString *str = [[NSString alloc] initWithUTF8String:pretty_str];
...
- (void)testGetString01276601_010000 {
    ...
    r_pln_init_set_ui(&polinom, 0b1010111110110000001);
    pln_init_set_ui(polinom.denominator, 0b1000000000000);
    mp_bitcnt_t stringSize = r_pln_str_size(polinom, 2);
    char pretty_str[stringSize];
    r_pln_get_str(pretty_str, polinom, 2);
    NSString *str = [[NSString alloc] initWithUTF8String:pretty_str];
